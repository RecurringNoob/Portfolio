    ...
    sections: [
      {
        ...
        projects: [
          {
            id: 'p-work-1',
            title: "Software Development Intern @ TechCorp",
            description: "Worked on full-stack development projects, contributing to both frontend and backend systems. Collaborated with cross-functional teams to deliver scalable solutions and optimize application performance.",
            category: "Internship",
            image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&q=80", // Team collaboration in modern office
            technologies: ["React", "Node.js", "PostgreSQL", "Git", "Agile"],
            match: "99% Match",
            year: "Summer 2024",
            rating: "Work",
            duration: "3 Months",
            ...
            tags: ["Full Stack", "Team Collaboration", "Agile"],
            links: {
              demo: "#",
              code: "#"
            },
            features: [
              {
                ...
                duration: "6 Weeks",
                desc: "Built user-facing features using React and integrated REST APIs."
              },
              {
                title: "Database Optimization",
                duration: "2 Weeks",
                desc: "Optimized SQL queries reducing page load time by 40%."
              },
              {
                title: "Code Reviews",
                duration: "Ongoing",
                desc: "Participated in daily code reviews and sprint planning sessions."
              }
            ]
          },
          {
            ...
            description: "Developed custom websites and web applications for small businesses and startups. Managed end-to-end project delivery from requirements gathering to deployment and maintenance.",
            category: "Freelance",
            image: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?w=800&q=80", // Solo developer working remotely
            technologies: ["JavaScript", "React", "WordPress", "Tailwind CSS"],
            match: "95% Match",
            year: "2023-2024",
            rating: "Work",
            duration: "1 Year",
            role: "Freelancer",
            difficulty: "Professional",
            tags: ["Client Work", "Web Development", "Project Management"],
            links: {
              demo: "#",
              code: "#"
            },
            features: [
              {
                ...
                duration: "12 Months",
                desc: "Delivered 8+ websites for clients across different industries."
              },
              {
                title: "Responsive Design",
                duration: "Ongoing",
                desc: "Ensured mobile-first, accessible designs for all projects."
              }
            ]
          }
        ]
